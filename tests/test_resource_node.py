# Old tests that mock strangely and of course don't work.
# Maybe fix later.
...
# from sscn.standard import Standard, ResourceNode


# class ResourceNodeTestCase(TestCase):
#     """Testcase for class `ResourceNode`"""
#     def test_get_non_cached_field(self):
#         """test getting new field value that hasn't cached"""
